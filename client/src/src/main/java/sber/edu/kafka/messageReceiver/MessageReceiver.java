...
public class MessageReceiver {
  ...
  private MessageReceiver() {
    bootstrapServers = System.getProperty("kafka.administrator.bootstrap-servers");
    topic = System.getProperty("kafka.administrator.topic");
      ...
      while (!isInterrupted.get()) {
        try {
          ...
          for (ConsumerRecord<String, String> record : records) {
            ...
            RestrictionEntity message = objectMapper.readValue(record.value(), RestrictionEntity.class);
